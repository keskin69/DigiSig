...
public class BookingsApi {
   ...
   * When creating a booking for a product of type \&quot;fixed\&quot; or \&quot;fixedCourse\&quot;, the eventId is required. eventIds are obtained by calling /availability/slots or /availability/matchingSlots .\n\n When creating a booking for a product of type \&quot;flexibleTime\&quot;, you can\neither specify the eventId or the startTime (in which case you can optionally specify the endTime. If no endTime is specified, Bookeo will automatically calculate the duration based on the options chosen)
   * @param booking 
